...
(static function() {
    ...
    \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addLLrefForTCAdescr('tx_myfirstgame_domain_model_playeer', 'EXT:myfirstgame/Resources/Private/Language/locallang_csh_tx_myfirstgame_domain_model_playeer.xlf');
    \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::allowTableOnStandardPages('tx_myfirstgame_domain_model_playeer');
})();
